...
const notifications = [
  { title: "Irlanda confirmado.", description: "48 dias para embarque" },
  { title: "Viagem para Madrid", description: "48 dias para embarque" },
  { title: "São Paulo Guarulhos Airport", description: "48 dias para embarque" },
];
          ...
          <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2">
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
              ...
              <Card x-chunk="dashboard-05-chunk-1">
                ...
                <CardContent>
                  <div className="text-xs text-muted-foreground">+25% no ultimo mês</div>
                </CardContent>
                <CardFooter>
              ...
              <Card x-chunk="dashboard-05-chunk-2">
                ...
                <CardContent>
                  <div className="text-xs text-muted-foreground">+10% diaria</div>
                </CardContent>
                <CardFooter>
              ...
              <CardContent className="grid gap-4">
                <div className="flex items-center space-x-4 rounded-md border p-4">
                  ...
                  <div className="flex-1 space-y-1">
                    <p className="text-sm font-medium leading-none">Habilitar todas</p>
                    <p className="text-sm text-muted-foreground">Gerar historico de seus roteiros.</p>
                  </div>
                  <Switch />
                </div>
                <div>
